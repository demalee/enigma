                                        ...
                                        <div class="quick_activity_wrap">
                                            ...
                                            <div class="single_quick_activity">
                                                <div class="count_content">
                                                    <p>Suppliers</p>
                                                    <h3><span class="counter">{{$sup->count()}}</span> </h3>
                                                </div>
                                                <a href="#" class="notification_btn">ES Data</a>
                                                <div id="bar1" class="barfiller">
                                                    <div class="tipWrap">
                                                        <span class="tip"></span>
                                                    </div>
                                                    <span class="fill" data-percentage="{{$sup->count()/100}}"></span>
                                                </div>
                                            </div>
                                            <!-- single_quick_activity  -->
                                            <div class="single_quick_activity">
                                                <div class="count_content">
                                                    <p>Employees</p>
                                                    <h3><span class="counter">{{$emp->count()}}</span> </h3>
                                                </div>
                                                <a href="#" class="notification_btn yellow_btn">ES Data</a>
                                                <div id="bar2" class="barfiller">
                                                    <div class="tipWrap">
                                                        <span class="tip"></span>
                                                    </div>
                                                    <span class="fill" data-percentage="{{$emp->count()/100}}"></span>
                                                </div>
                                            </div>
